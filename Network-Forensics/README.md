...
**Figure 4.** HTTP requests generated during directory enumeration using Gobuster.

![Directory Enumeration](Evidence/Screenshots/gobuster.png)

**Figure 5.** Stored Cross-Site Scripting (XSS) payload submitted to the vulnerable `reviews.php` endpoint.

![Stored XSS Payload](Evidence/Screenshots/xss-payload.png)

**Figure 6.** Administrator session cookie (`PHPSESSID`) captured and reused to hijack the authenticated session.

![Session Hijacking](Evidence/Screenshots/session-hijacking.png)

**Figure 7.** Local File Inclusion (LFI) exploitation of `log_viewer.php` using a directory traversal payload to access `/etc/passwd`.
...
**Figure 8.** RetailBreach investigation scenario describing the suspected compromise of the ShopSphere web application.

![Investigation Scenario](Evidence/Screenshots/lab-scenario.png)

**Figure 9.** Packet capture (PCAP) provided as the primary forensic evidence for reconstructing the attack.

![PCAP Evidence](Evidence/Screenshots/pcap-file.png)
...
**Figure 8.** Protocol Hierarchy Statistics providing an overview of the network protocols observed within the captured traffic.

![Protocol Hierarchy](Evidence/Screenshots/protocol-hierarchy.png)

**Figure 9.** HTTP conversations used to correlate attacker activity with the victim web application.
...
**Figure 10.** Wireshark packet analysis used to reconstruct HTTP communications throughout the investigation.

![Wireshark Packet Analysis](Evidence/Screenshots/packet-analysis.png)

**Figure 11.** Follow HTTP Stream used to reconstruct attacker requests and validate exploitation activity.

![Follow HTTP Stream](Evidence/Screenshots/http-stream.png)
...
**Figure 12.** Timeline of attacker activity reconstructed from HTTP requests and packet timestamps.

![Attack Timeline](Evidence/Screenshots/attack-timeline.png)

**Figure 13.** HTTP requests illustrating the progression from reconnaissance to post-exploitation.

![HTTP Request Timeline](Evidence/Screenshots/http-request-sequence.png)
...
**Figure 14.** HTTP requests generated during automated directory enumeration using Gobuster.
...
**Figure 15.** Malicious JavaScript payload submitted through the vulnerable `reviews.php` endpoint.
...
**Figure 16.** HTTP traffic confirming exfiltration of the administrator's authenticated session cookie.

![Cookie Theft](Evidence/Screenshots/cookie-theft.png)
...
**Figure 17.** Authenticated requests demonstrating successful administrator session hijacking.
...
**Figure 18.** Exploitation of the Local File Inclusion (LFI) vulnerability through the `log_viewer.php` component.
